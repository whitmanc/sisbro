...
(function(a){
    a.fn.amazon_scroller=function(p){
        ...
        var g=p&&p.scroller_time_interval?p.scroller_time_interval:"300000";
        ...
        if(dom.find("ul").length==0||dom.find("li").length==0){
            ...
            dom.find("ul:first").children("li").children("a").children("img");
        if(h=='enable'){
        ...
        m=parseInt(m);
        dom.find("ul:first").children("li").css("height","190px");
    ...
    a.children("li").css('background-image','url("/assets/arrow.gif")');
